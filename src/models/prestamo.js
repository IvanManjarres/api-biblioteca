...
const Prestamo = sequelize.define('Prestamo', {
     ...
     libroId: { type: DataTypes.INTEGER, allowNull: false, references: { model: 'Libros', key: 'id' } }, 
     ...
     fechaDevolucion: { type: DataTypes.DATE, allowNull: true, defaultValue: null } }, { tableName: 'Prestamos', timestamps: true }); 
